...
=======
OlistのブラジルECサイトデータを使い、注文金額・送料・配送状況と顧客レビューの関係を分析するプロジェクトです。AWS（S3・Athena）とSQLでデータを準備し、Python（Positron / Jupyter Notebook）で分析しています。分析結果を顧客体験や配送・販売施策の改善につながるビジネス上の示唆に結びつけることを目的としてます。
